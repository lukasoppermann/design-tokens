      ...
      <div className={`${style} select-menu ${className}`}>
        ...
        >
          ...
          <span className='select-menu__caret'>
            <svg className='svg' width='8' height='7' viewBox='0 0 8 7' xmlns='http://www.w3.org/2000/svg'><path d='M3.646 5.354l-3-3 .708-.708L4 4.293l2.646-2.647.708.708-3 3L4 5.707l-.354-.353z' fillRule='evenodd' fillOpacity='1' stroke='none' /></svg>
          </span>
        </button>
        <ul
