...
const getStandardTransformer = (formatKeys: formatKeysType) => {
  ...
  return (token: internalTokenInterface): StandardTokenInterface | StandardTokenGroup => {
