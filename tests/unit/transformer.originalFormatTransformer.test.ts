...
describe('originalFormatTransfomer', () => {
  ...
  // test('multi color token', () => expect(transformer(extractedFigmaTokens.colorAndGradient)).toStrictEqual(transformedOriginalTokens.colorAndGradient))
  // test('multi color token', () => expect(transformer(extractedFigmaTokens.gradientAndColor)).toStrictEqual(transformedOriginalTokens.gradientAndColor))
